# gellany_dga2_ml
archive machine learning OOP algo refactoring from other resource to threat hunting by the prediction of Domain generation algorithms (DGA) algo based on entroby algo 
